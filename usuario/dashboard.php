    ...
    <div class="col-md-4 col-sm-6 mb-3">
      <div class="card shadow-sm dashboard-card">
        <div class="card-body text-center">
          ...
          <a href="perfil.php" class="btn btn-primary dashboard-btn">Acessar Perfil</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4 col-sm-6 mb-3">
      <div class="card shadow-sm dashboard-card">
        <div class="card-body text-center">
          ...
          <a href="gerar_qr.php" class="btn btn-primary dashboard-btn">Gerar QR Code</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4 col-sm-6 mb-3">
      <div class="card shadow-sm dashboard-card">
        <div class="card-body text-center">
          ...
          <a href="historico_viagens.php" class="btn btn-primary dashboard-btn">Ver Histórico</a>
        </div>
      </div>
    </div>
  </div>
