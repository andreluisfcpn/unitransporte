<?php
$pageTitle = "Imprimir Carteira Individual"; // Título desta página
...
$stmt = $pdo->prepare("SELECT * FROM users WHERE id = :id AND role = 'usuario'");
...
// Converte para JSON e URL-encodes
...
<div class="container mt-4">
  <div class="row justify-content-center">
    <div class="col-md-8">
      <h2 class="text-center mb-4">Carteira Universitária - <?php echo htmlspecialchars($user['nome']); ?></h2>
      ...
      <div class="text-center mt-4 mb-4 action-buttons">
        ...
        <a href="imprimir_carteiras.php" class="btn btn-secondary ml-2">Voltar</a>
      </div>
    </div>
  </div>
</div>
